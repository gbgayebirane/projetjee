...
<html lang="en">
         ...
         <section class="section swatch-white-red has-top">
                ...
                <div class="container ">
                    <header class="section-header underline">
                        <h1 class="headline super hairline">Liste Entree Produit</h1>
                    </header>
                             ...
                             <table class="table table-hover">
                                ...
                                <tbody>
                                 <c:if test="${entrees !=null }">
									   <c:forEach items="${entrees }" var="prof">
                                    <tr>
                                      
									   <td>${prof.id }</td>
                                       
                                        <td>${prof.qtStockE}</td>
                                       <td>${prof.produit.nom}</td>
                    ...
                    <div class="row-fluid col-md-6">
                        <div class="span6">
                       <c:if test="${result==1}">
                                <div id="message" class="alert alert-success">Produit mis a jour</div>
                                </c:if>
                             <form  method="Post" action="Entree"  class="contact-form">
                                <div class="form-group form-icon-group">
                                    <input class="form-control" id="name" name="qtStock" placeholder="Quantite a Entree" type="text" required/>
                                </div>
                                <div class="form-group  form-icon-group">
                                <label for="icon_prefix">Produit</label>
                                <select class="form-control"  name="produit">
                                   
                					  <c:forEach items="${produits}" var="serv">
    ...
    $(document).ready(function(){
        $("#message").show().fadeOut(5000).css("color","blue");
    });
</script>
</html>